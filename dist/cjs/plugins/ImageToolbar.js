...
exports.ImageToolbarKey = void 0;
...
class ImageToolbarView {
    constructor(options, view) {
        ...
        alignments.forEach(alignment => {
            ...
            button.onclick = event => {
                ...
                view.dispatch(view.state.tr.setNodeMarkup(pos, null, Object.assign(Object.assign({}, node.attrs), { align: node.attrs.align == alignment ? null : alignment })));
            };
        });
    ...
    update(view, prevState) {
        ...
        if (!(view.state.selection instanceof prosemirror_state_1.NodeSelection) || (node.type != view.state.schema.nodes.image)) {
...
;
exports.ImageToolbarKey = new prosemirror_state_1.PluginKey("ImageToolbar");
function ImageToolbarPlugin(options) {
    return new prosemirror_state_1.Plugin({
        key: exports.ImageToolbarKey,
        view(editorView) {
