...
function backspaceCodeBlock(state, dispatch, view) {
    if (!isSelectionEntirelyInsideCodeBlock(state))
        return false;
    return prosemirror_commands_1.chainCommands(prosemirror_commands_1.deleteSelection, deleteCodeBlock, prosemirror_commands_1.joinBackward, prosemirror_commands_1.selectNodeBackward)(state, dispatch, view);
}
