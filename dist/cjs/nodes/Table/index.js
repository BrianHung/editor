...
function tableEditing({ allowTableNodeSelection = false } = {}) {
    return new prosemirror_state_1.Plugin({
        ...
        appendTransaction(_, oldState, state) {
            return cellselection_1.normalizeSelection(state, fixtables_1.fixTables(state, oldState), allowTableNodeSelection);
        }
    });
}
...
var table_nodeview_1 = require("./table-nodeview");
Object.defineProperty(exports, "updateColumnsOnResize", { enumerable: true, get: function () { return table_nodeview_1.updateColumns; } });
Object.defineProperty(exports, "TableView", { enumerable: true, get: function () { return table_nodeview_1.TableView; } });
...
class TableHeader extends Node_1.default {
    get name() {
        return 'tableheader';
    }
    get schema() {
